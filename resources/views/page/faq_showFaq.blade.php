...
@section('content')
    ...
    <div style="display:table; min-height:1px; _height:1px">
        ...
        <h2>Каковы визовые условия для прохождение гиюра?</h2>
        ...
        <p style="text-align:center"><a target="_blank" href="/print/questions/view/2/58025.html">Версия для печати</a></p>
