...
<div class="container">
    ...
    <div class="request">
        <form action="/sendform/" method="post">
            <input type="hidden" name="module" value="sendform">
            <input type="hidden" name="action" value="send">
            <p style="font:8pt verdana;margin-top:15px;">В нерабочее время заполните форму <br>и с Вами свяжутся в часы работы</p>				<label style="font:8pt verdana;">Имя, фамилия</label>
            ...
            <input type="text" class="inp" name="form_email" value="">
            <label style="font:8pt verdana;">Введите код</label>
            <img src="/captcha2/CaptchaSecurityImages.php" alt=""><input id="security_code" name="security_code" type="text">
    ...
    <form action="" class="search" id="searchbox_005526002188423334622:yaydshnxre4" onsubmit="return false;">
        ...
        <input name="siteurl" type="hidden" value="www.aptekman.co.il/print/questions/view/78997.html"><input name="ref" type="hidden" value="www.aptekman.co.il/questions/view/78997.html"><input name="ss" type="hidden" value=""></form>
...
<div class="footer">
    <p>
        <a href="/">Главная</a> |				<a href="/services/">О нас</a> |				<a href="/questions/">Вопросы и ответы</a> |				<a href="/articles/">Статьи</a> |				<a href="/books/">Книги</a> |				<a href="/video/">Видео</a>				</p>

    <p><b>Официальный сайт «Ави&nbsp;Аптекман, адвокаты, судебные исполнители» ©&nbsp;<nobr>2004</nobr></b><br>Бат Ям, ул. Нисенбаум д. 33 "Бат Ямон" 3 этаж, офис 314. Телефон: <nobr>03-6136021</nobr></p>
...
<iframe frameborder="0" src="about:blank" class="cse-overlay-bg" style="border: 0px; vertical-align: bottom; display: none; opacity: 0;"></iframe><div class="cse-overlay-bg" style="display: none; opacity: 0.5;"></div><div class="cse-overlay" tabindex="0" role="dialog" aria-labelledby=":0" style="display: none;"><div class="cse-overlay-title cse-overlay-title-draggable"><span class="cse-overlay-title-text" id=":0" role="heading"></span><span class="cse-overlay-title-close" role="button" tabindex="0" aria-label="Close"></span></div><div class="cse-overlay-content"><div id="results_005526002188423334622:yaydshnxre4" style="">
        ...
        </div></div><div class="cse-overlay-buttons"></div></div><span tabindex="0" style="display: none; position: absolute;"></span><table cellspacing="0" cellpadding="0" class="gstl_50 gssb_c" style="width: 100%; display: none; top: -1px; position: absolute; left: 0px;"><tbody><tr><td class="gssb_f"></td><td class="gssb_e" style="width: 100%;"></td></tr></tbody></table></body></html>